    ...
    while True:
        ...
        if 'y' in choice:  # roll the dice
            if dice_value % 2 == 0:  # no fight, lucky kido
                print_pause(f"Oh, you are a lucky kiddo. You got {dice_value}. Go back to your field."
                            "Happy that I don't have to hurt you.\n")
                print_pause(
                    "When you go back, you can say to others that you defeated me, and you won me over!\n")
